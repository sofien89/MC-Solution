          ...
          <div className="row">
            <div className="col-xl-9 col-lg-8 order-lg-last">
              <div className="details-wrapper pl-xl-5">
                ...
                Le SIP Trunk est une solution compatible avec tous les équipements téléphoniques 
                et fonctionne à partir de tout type d’accès à Internet au sein de l’entreprise.
                </p>
                <img
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 order-lg-first">
              <div className="sidebar md-mt-100">
                <div className="category-list">
                  ...
                  <ul>
                    <li>
                      <a href="/service-trunk" className="active">
                        Trunk SIP
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="/service-cloud">Administration des serveurs Cloud</a>
                    </li>
                    <li>
