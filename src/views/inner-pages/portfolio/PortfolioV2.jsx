...
//             <a
//               href={`/${product.slug}?cid=${product._id}`}
//             >
    ...
    <div className="main-page-wrapper">
      ...
      <div className="fancy-hero-six">
        <div className="container">
          <h1 className="heading">Grid 23 Columns</h1>
          <p className="sub-heading">
            111An original way to show your works in a good appearance
            {/* {renderProducts(product.products)} aaa */}
          </p>
        </div>
      </div>
      {/* /.fancy-hero-six */}
